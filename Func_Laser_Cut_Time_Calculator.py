...
def laser_calculator(directory_user, thickness_user, material_user):
    ...
    for e in msp:
        ...
        if e.dxf.layer == "OUTER" or e.dxf.layer == "IV_ARC_CENTERS" or e.dxf.layer == "IV_INTERIOR_PROFILES" or e.dxf.layer == "IV_TOOL_CENTER" or e.dxf.layer == "IV_TOOL_CENTER_DOWN" or e.dxf.layer == "IV_FEATURE_PROFILES" or e.dxf.layer == "AM_KONT" or e.dxf.layer == "Visible (ISO)" or e.dxf.layer == "0": 
    ...
    if material == "Carbono":
        cut_time = (total_perimeter/1000)*time_cut_carb[sheet_thickness.index(thickness)] + time_hole_carb[sheet_thickness.index(thickness)]*(interior_profiles + 1)

    elif material == "Inox":
        cut_time = (total_perimeter/1000)*time_cut_stain[sheet_thickness.index(thickness)] + time_hole_stain[sheet_thickness.index(thickness)]*(interior_profiles + 1)
...
print(laser_calculator(r"C:\Users\U57534\OneDrive - Bühler\Desktop\STE\APJA-48293\APJA-48293-761.dxf", 2, "Carbono")[0])